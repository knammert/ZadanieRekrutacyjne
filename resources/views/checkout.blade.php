                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="modal-title fs-2 fw-bolder" id="loginModalLabel">Logowanie</div>
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            <button type="button" class="loginButton">Zaloguj</button>
                            <center><small> Nie pamiętasz hasła?<a class="text-primary" href=""> Przypominij hasło.</a>
                                </small></center>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" enctype="multipart/form-data" id="checkoutForm" name="checkoutForm">
                ...
                <div class="row m-3">
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        ...
                        <button type="button" class="loginButton mt-2" data-bs-toggle="modal"
                            data-bs-target="#loginModal">Logowanie</button>
                        <div class="mt-1">
                        ...
                        <div class="newAccount" id="newAccount">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <span toggle="#password" class="fa fa-fw fa-eye field-icon toggle-password eyeiconcolor"></span>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        ...
                        <div class="p-2 row mt-3">
                            ...
                            @foreach ($shippingMethods as $shippingMethod)
                                <div class=" d-flex w-100 mb-5 justify-content-center align-items-center">
                                    ...
                                    <div class="d-flex">
                                        <img class="img-fluid"
                                            src="{{ asset('storage/shipping/' . $shippingMethod->img . '.png') }}"
                                            alt="brak" title="" height="30px" width="70px" />
                                    </div>
                        ...
                        <div class="p-2 row mt-3">
                            ...
                            @foreach ($paymentMethods as $paymentMethod)
                                <div class=" d-flex w-100 mb-5 align-items-center" id="payment-{{ $paymentMethod->id }}">
                                    ...
                                    <div class="d-flex ">
                                        <img class=""
                                            src="{{ asset('storage/payment/' . $paymentMethod->img . '.png') }}"
                                            alt="brak" title="" width="70" height="45"></a>
                                    </div>
                        ...
                        <button type="button" class="discountButton mt-2 mb-5" id="discountButton">Dodaj kod
                            rabatowy</button>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 ">
                        ...
                        <div class="p-2 row mt-3">
                            @foreach ($cartItems as $cartItem)
                                <div class="d-flex w-100 mb-3">
                                    <div class="d-flex">
                                        <img class="" src="{{ asset('storage/products/testowy.jpg') }}" alt="brak" title=""
                        ...
                        <div class="form-group mt-3 ">
                            <div class="form-group row">
                                ...
                                <span class="text-danger" id="captchaErrorMsg"></span>
                            </div>
                        </div>
